...
<ul class="list-group">
  ...
  <li class="list-group-item">מיקום: @if($elector->AddCode !=0.0) {{$elector->kalfy_data->place_details}} @endif</li> 
  <li class="list-group-item">כתובת: @if($elector->AddCode !=0.0) {{$elector->kalfy_data->street_name}} @endif </li>
