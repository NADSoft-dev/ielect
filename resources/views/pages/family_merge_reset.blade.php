...
<li class="active">איפוס איחוד משפחות</li>
</ol>


  <div class="panel panel-default">
  <div class="panel-heading">איפוס איחוד משפחות</div>
...
<table class="table table-striped table-bordered familyTable">
<thead>
  <tr>
    <th>
      שם משפחה מקורי
...
<tr>
<td>{{$family->originalFamilyName}}</td>
<td>{{$family->FamilyName}}</td>
<td><button class="btn btn-xs btn-danger resetFamilyJoin" data-original="{{$family->originalFamilyName}}" data-new="{{$family->FamilyName}}">איפוס</button></td>
</tr>
...
<h4>האם אתה מאשר ביצוע איפוס איחוד משפחות לפי הנתונים הנ"ל ?</h4>
