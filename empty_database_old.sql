...
--
-- Host: localhost:3306
-- Generation Time: Jan 08, 2018 at 02:19 PM
...
ALTER TABLE `electors` ADD FULLTEXT KEY `FamilyName` (`FamilyName`,`PersonalName`,`FatherName`);
ALTER TABLE `electors` ADD FULLTEXT KEY `FamilyName_2` (`FamilyName`,`PersonalName`);
ALTER TABLE `electors` ADD FULLTEXT KEY `PersonalName` (`PersonalName`);
