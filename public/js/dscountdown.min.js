...
(function($){
	...
	$.fn.dsCountDown = function(givenOptions){
		...
		var defaults = {
			...
			titleDays: 'ימים',			// Set the title of days
			titleHours: 'שעות',		// Set the title of hours
			titleMinutes: 'דקות',	// Set the title of minutes
			titleSeconds: 'שניות',	// Set the title of seconds
